...
const en: Strings = {
  ...
  common: {
    seeAll: 'See all work →', contact: 'Contact Me', viewWork: 'View My Work',
    ...
    interestedWorking: 'Ready to build better teams?',
    footerTag: 'HR & Sales Training · HRD · Based in Vietnam',
    footerCopy: '© 2026 Nguyen Thanh Quan · motchinchintam.com',
  },
  home: {
    greeting: "Hi, I'm Quân 👋",
    eyebrow: 'HR & Sales Training · HRD',
    heroHeadline: 'I build training systems that cut ramp-up time and reduce team churn.',
    heroSub: '6+ years scaling teams, designing onboarding programs, and cutting churn — across SaaS, retail, and duty-free environments.',
    selectedWork: 'Selected Work',
    fullAbout: 'More about me →',
    aboutEyebrow: 'About Me',
    aboutHeadline: 'Mindset over title.',
    aboutBody: 'I care more about building systems that last than hitting short-term numbers. Whether it\'s designing a training program from scratch, cutting churn through better client engagement, or scaling a team across multiple cities — I focus on root causes, not symptoms.',
    statsYrs: 'Yrs Exp', statsTrained: 'Trained',
    statsAccounts: 'Merchants', statsPass: 'Pass Rate',
    ...
    socialCaptions: [
      'Great session with the team today — wrapped up a full onboarding module for new sales reps.',
      'Finished reading "The Coaching Habit" — highly recommend if you work in L&D or HR.',
      "Sometimes the best training tool is a conversation.",
    ],
  },
  work: {
    pageTitle: 'Work',
    pageSub: 'Selected projects across training design, team building, and revenue operations. Each project includes context, what I did, and the measurable result.',
  },
  about: {
